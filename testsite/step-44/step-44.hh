...
#include <cuda_driver_step-44.h>
#include <cuda_driver_step-44.hh>
...
step44::MyFancySimulation::MyFancySimulation(int argc,
                                                   char *argv[],
                                                   SciPAL::GPUInfo &g)
    : gpuinfo(g)
{
...
void step44::MyFancySimulation::run()
{
   ...
   // instantiate an object of the driver class
    step44::CUDADriver testcase(&__solution(0), __solution.size() );
